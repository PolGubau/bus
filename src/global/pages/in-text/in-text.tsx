			...
			{/* <div className="flex-1 flex flex-col justify-center text-[28px] leading-10">
 				<div className="mb-6">
					...
					<select
						...
						style={{
							backgroundImage: 'url("data:image/svg+xml;base64,PD94bWwgdmVyc2lvbj0iMS4wIiBlbmNvZGluZz0i...")', // recorta tu base64 aquí
						}}
					>
					...
					{findSoonestStop[selectedIndex] > 0 && (
						<div className={`mt-2 ${findSoonestStop[selectedIndex] >= 15 ? "opacity-50" : ""}`}>
							quedan{" "}
							<span className={`inline-block ${findSoonestStop[selectedIndex] < 15 ? "text-red-500" : ""}`}>
